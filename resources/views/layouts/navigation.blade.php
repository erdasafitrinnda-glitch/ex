<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <!-- Settings Dropdown (sudah login) / Login & Register (belum login) -->
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('login') }}"
                           class="px-4 py-2 text-sm font-medium text-gray-700 border border-gray-300 rounded-md hover:bg-gray-50 transition duration-150">
                            Login
                        </a>
                        <a href="{{ route('register') }}"
                           class="px-4 py-2 text-sm font-medium text-white bg-gray-800 rounded-md hover:bg-gray-700 transition duration-150">
                            Register
                        </a>
                    </div>
                @endauth
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                <x-responsive-nav-link :href="route('pesan')" :active="request()->routeIs('pesan')">
                    {{ __('Pesan') }}
                </x-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            @else
                ...
                <div class="px-4 flex flex-col gap-2">
                    <a href="{{ route('login') }}"
                       class="text-center px-4 py-2 text-sm font-medium text-gray-700 border border-gray-300 rounded-md hover:bg-gray-50 transition duration-150">
                        Login
                    </a>
                    <a href="{{ route('register') }}"
                       class="text-center px-4 py-2 text-sm font-medium text-white bg-gray-800 rounded-md hover:bg-gray-700 transition duration-150">
                        Register
                    </a>
                </div>
            @endauth
